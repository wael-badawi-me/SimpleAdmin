...
public class CategoryModel
{
    ...
    //public List<ProductModel> ProductCategories
    //{
    //    get
    //    {
    //        return category.ProductCategory.Select(c => new ProductModel(c.Product)).ToList();

    //    }
    //    set
    //    {
    //        category.ProductCategory = new List<ProductCategory>();
    //        foreach (ProductModel product in value)
    //        {
    //            category.ProductCategory.Add(new ProductCategory { Product = product.DBProduct });
    //        }
    //    }
    //}
